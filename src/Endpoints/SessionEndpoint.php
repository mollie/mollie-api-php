...
class SessionEndpoint extends EndpointCollection
{
    ...
    public function update($resourceId, array $data = [])
    {
        ...
        return $this->updateResource($resourceId, $data);
    }
    ...
    public function get($resourceId, array $parameters = [])
    {
        ...
        return $this->readResource($resourceId, $parameters);
    }
    ...
    {
        return $this->deleteResource($resourceId, $parameters);
    }
