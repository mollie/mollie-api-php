...
- Typed include/embed builders for query arrays: `PaymentIncludes`, `PaymentEmbeds`, `MethodIncludes`, `ClientEmbeds`, `RefundEmbeds`, `CaptureEmbeds`, and `ChargebackEmbeds`. Existing raw string and array query values continue to work.
